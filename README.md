# Tourify-Your Smart Digital Tour Guide
Tourify is a smart travel planning web app that automates itineraries, estimates trip costs, fetches live weather updates, manages bookings, and provides checklists—all in one place.This project allows users to plan trips end-to-end by offering modules such as Trip Planning, Transport Booking, Hotel Booking, Nearby Food Spots, Budget Split, and Women’s Safety Features—making travel planning seamless, efficient, and personalized.
...
*APIs: Google Maps (for search/navigation)
